...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#selectBtn").click(function () {
			...
			$("#hide-company").val($("#select-company").val());
			$("#hide-phone").val($("#select-phone").val());
			$("#hide-source").val($("#select-source").val());
			$("#hide-owner").val($("#select-owner").val());
			$("#hide-mphone").val($("#select-mphone").val());
			$("#hide-state").val($("#select-state").val());
			pageList(1,$("#activityPage").bs_pagination('getOption', 'rowsPerPage'));
		});
		pageList(1,3);
	});
	...
	function pageList(pageNo,pageSize) {
		...
		$("#select-company").val($("#hide-company").val());
		$("#select-phone").val($("#hide-phone").val());
		$("#select-source").val($("#hide-source").val());
		$("#select-owner").val($("#hide-owner").val());
		$("#select-mphone").val($("#hide-mphone").val());
		$("#select-state").val($("#hide-state").val());
		$.ajax({
			url:"workbench/clue/select.do",
			type:"get",
			data:{
		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div class="btn-toolbar" role="toolbar" style="height: 80px;">
				<form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
				  ...
				  <button id="selectBtn" type="submit" class="btn btn-default">查询</button>
				  
				</form>
			</div>
			<div class="btn-toolbar" role="toolbar" style="background-color: #F7F7F7; height: 50px; position: relative;top: 40px;">
				<div class="btn-group" style="position: relative; top: 18%;">
				  <button id="createClueBtn" type="button" class="btn btn-primary" data-toggle="modal" data-target="#createClueModal"><span class="glyphicon glyphicon-plus"></span> 创建</button>
