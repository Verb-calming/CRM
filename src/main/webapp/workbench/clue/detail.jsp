...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#linkedActivityBody").on("click",$("input[name=radios]"),function () {
		...
		$("#searchName").keydown(function (event) {
			if (event.keyCode===13){
				$.ajax({
					url:"workbench/clue/searchName.do",
					type:"GET",
					data:{
					...
					success:function (data) {
						...
						$.each(data,function (index,element) {
							html += '<tr>';
							html += '<td><input id="checkboxs" name="radios" type="checkbox" value="'+element.id+'"/></td>';
		...
		$("#linkBtn").click(function () {
			$.ajax({
				url:"workbench/clue/selectAllUnLinkedActivity.do",
				type:"GET",
				data:{
					clueId: "${clue.id}"
				},
		...
		$("#saveLinkedActivity").click(function () {
			...
			if ($checked.length === 0) {
				...
				$.ajax({
					url:"workbench/clue/saveLinkedActivity.do",
					type:"POST",
					data:param,
					dataType:"json",
					success:function (data) {
...
<body>
		...
		<div class="modal-dialog" role="document" style="width: 80%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button id="saveLinkedActivity" type="button" class="btn btn-primary">关联</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div>
		<div style="position: relative; top: 60px; left: 40px;">
			...
			<div>
				<a id="linkBtn" data-toggle="modal" data-target="#bundModal" style="cursor: pointer; text-decoration: none;"><span class="glyphicon glyphicon-plus"></span>关联市场活动</a>
			</div>
		</div>
	</div>
