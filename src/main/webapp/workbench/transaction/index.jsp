...
<script type="text/javascript">
	...
	$(function(){
		$("#selectBtn").click(function () {
			...
			$("#hide-customerName").val($("#select-customerName").val());
			$("#hide-stage").val($("#select-state").val());
			$("#hide-type").val($("#select-type").val());
			$("#hide-clueSource").val($("#select-source").val());
			$("#hide-contactsName").val($("#select-contactsName").val());
	...
	function pageList(pageNo,pageSize) {
		...
		$("#select-customerName").val($("#hide-customerName").val());
		$("#select-stage").val($("#hide-state").val());
		$("#select-type").val($("#hide-type").val());
		$("#create-clueSource").val($("#hide-source").val());
		$("#select-contactsName").val($("#hide-contactsName").val());
		$.ajax({
			url:"workbench/transaction/select.do",
			type:"get",
			data:{
				owner:$.trim($("#select-owner").val()),
				name:$.trim($("#select-name").val()),
				customerName:$.trim($("#select-customerName").val()),
				stage:$.trim($("#select-stage").val()),
				type:$.trim($("#select-type").val()),
				source:$.trim($("#create-clueSource").val()),
				contactsName:$.trim($("#select-contactsName").val()),
				pageNo:pageNo,
				pageSize:pageSize
			},
			dataType:"json",
