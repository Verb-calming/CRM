...
<script type="text/javascript">
	...
	$(function(){
		...
		* */
        ...
        $("#saveRemarkBtn").click(function () {
            $.ajax({
                url:"workbench/active/saveRemark.do",
                data:{
                ...
                success:function (data) {
                    // data={"succeed":true/false,"ar":{ActivityRemark对象}}
                    if (data.succeed) {
                        let html = "";
        ...
        $("#updateRemarkBtn").click(function () {
            let id = $("#remarkId").val();
            $.ajax({
                url:"workbench/active/updateRemark.do",
                data:{
                    id:id,
	...
	function showActivityRemark() {
		$.ajax({
			url:"workbench/active/getRemarkInfo.do",
			data:{
				activityId:"${activity.id}"
			},
			type:"get",
			...
			success:function (data) {
				...
				$.each(data,function (index,element) {
					...
					html += '<font color="gray">市场活动</font> <font color="gray">-</font> <b>${activity.name}</b> <small id="s'+element.id+'" style="color: gray;">'+(element.editFlag==0?element.createTime:element.editTime)+'由'+(element.editFlag==0?element.createBy:element.editBy)+'</small>';
					html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
    ...
    function deleteRemark(id) {
        $.ajax({
            url:"workbench/active/deleteRemark.do",
            type:"post",
            data:{
                id:id
            },
